...
public anywheresoftware.b4a.objects.ListViewWrapper _lstv = null;
...
mostCurrent._lstv.Initialize(mostCurrent.activityBA,"ls");
 //BA.debugLineNum = 30;BA.debugLine="lstv.Color=Colors.ARGB(255,142,24,46)";
mostCurrent._lstv.setColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (255),(int) (142),(int) (24),(int) (46)));
 //BA.debugLineNum = 31;BA.debugLine="Activity.AddView(lstv,0,0,Activity.Width,Activity";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._lstv.getObject()),(int) (0),(int) (0),mostCurrent._activity.getWidth(),mostCurrent._activity.getHeight());
...
mostCurrent._lstv.AddSingleLine2("		"+"تنظیمات",(Object)("SETTINGS"));
 //BA.debugLineNum = 41;BA.debugLine="lstv.AddSingleline2(\"		\"&\"دسترسی\",\"ACCESSIBILITY_";
mostCurrent._lstv.AddSingleLine2("		"+"دسترسی",(Object)("ACCESSIBILITY_SETTINGS"));
 //BA.debugLineNum = 42;BA.debugLine="lstv.AddSingleline2(\"		\"&\"تنظیمات بیسیم و شبکه\",\"";
mostCurrent._lstv.AddSingleLine2("		"+"تنظیمات بیسیم و شبکه",(Object)("AIRPLANE_MODE_SETTINGS"));
 //BA.debugLineNum = 43;BA.debugLine="lstv.AddSingleline2(\"		\"&\"تنظیمات WIFI\",\"WIFI_SET";
mostCurrent._lstv.AddSingleLine2("		"+"تنظیمات WIFI",(Object)("WIFI_SETTINGS"));
 //BA.debugLineNum = 44;BA.debugLine="lstv.AddSingleline2(\"		\"&\"تنظیمات بلوتوث\",\"BLUETO";
mostCurrent._lstv.AddSingleLine2("		"+"تنظیمات بلوتوث",(Object)("BLUETOOTH_SETTINGS"));
 //BA.debugLineNum = 45;BA.debugLine="lstv.AddSingleline2(\"		\"&\"تنظیمات IP\",\"WIFI_IP_SE";
mostCurrent._lstv.AddSingleLine2("		"+"تنظیمات IP",(Object)("WIFI_IP_SETTINGS"));
 //BA.debugLineNum = 46;BA.debugLine="lstv.AddSingleline2(\"		\"&\"تنظیمات APN\",\"APN_SETTI";
mostCurrent._lstv.AddSingleLine2("		"+"تنظیمات APN",(Object)("APN_SETTINGS"));
 //BA.debugLineNum = 47;BA.debugLine="lstv.AddSingleline2(\"		\"&\"گزینه های برنامه نویس\",";
mostCurrent._lstv.AddSingleLine2("		"+"گزینه های برنامه نویس",(Object)("APPLICATION_DEVELOPMENT_SETTINGS"));
 //BA.debugLineNum = 48;BA.debugLine="lstv.AddSingleline2(\"		\"&\"مدیریت برنامه های نصب ش";
mostCurrent._lstv.AddSingleLine2("		"+"مدیریت برنامه های نصب شده",(Object)("APPLICATION_SETTINGS"));
 //BA.debugLineNum = 49;BA.debugLine="lstv.AddSingleline2(\"		\"&\"مدیریت تمام برنامه های";
mostCurrent._lstv.AddSingleLine2("		"+"مدیریت تمام برنامه های نصب شده",(Object)("MANAGE_ALL_APPLICATIONS_SETTINGS"));
 //BA.debugLineNum = 50;BA.debugLine="lstv.AddSingleline2(\"		\"&\"تنظیمان رومینگ\",\"DATA_R";
mostCurrent._lstv.AddSingleLine2("		"+"تنظیمان رومینگ",(Object)("DATA_ROAMING_SETTINGS"));
 //BA.debugLineNum = 51;BA.debugLine="lstv.AddSingleline2(\"		\"&\"تنظیمات تاریخ و زمان\",\"";
mostCurrent._lstv.AddSingleLine2("		"+"تنظیمات تاریخ و زمان",(Object)("DATE_SETTINGS"));
 //BA.debugLineNum = 52;BA.debugLine="lstv.AddSingleline2(\"		\"&\"اطلاعات دستگاه\",\"DEVICE";
mostCurrent._lstv.AddSingleLine2("		"+"اطلاعات دستگاه",(Object)("DEVICE_INFO_SETTINGS"));
 //BA.debugLineNum = 53;BA.debugLine="lstv.AddSingleline2(\"		\"&\"صفحه نمایش\",\"DISPLAY_SE";
mostCurrent._lstv.AddSingleLine2("		"+"صفحه نمایش",(Object)("DISPLAY_SETTINGS"));
 //BA.debugLineNum = 54;BA.debugLine="lstv.AddSingleline2(\"		\"&\"روش ورودی صفحه کلید\",\"I";
mostCurrent._lstv.AddSingleLine2("		"+"روش ورودی صفحه کلید",(Object)("INPUT_METHOD_SETTINGS"));
 //BA.debugLineNum = 55;BA.debugLine="lstv.AddSingleline2(\"		\"&\"زبان صفحه کلید\",\"INPUT_";
mostCurrent._lstv.AddSingleLine2("		"+"زبان صفحه کلید",(Object)("INPUT_METHOD_SUBTYPE_SETTINGS"));
 //BA.debugLineNum = 56;BA.debugLine="lstv.AddSingleline2(\"		\"&\"مدیریت حافظه\",\"INTERNAL";
mostCurrent._lstv.AddSingleLine2("		"+"مدیریت حافظه",(Object)("INTERNAL_STORAGE_SETTINGS"));
 //BA.debugLineNum = 57;BA.debugLine="lstv.AddSingleline2(\"		\"&\"زبان سیستم\",\"LOCALE_SET";
mostCurrent._lstv.AddSingleLine2("		"+"زبان سیستم",(Object)("LOCALE_SETTINGS"));
 //BA.debugLineNum = 58;BA.debugLine="lstv.AddSingleline2(\"		\"&\"سرویس های مکانی\",\"LOCAT";
mostCurrent._lstv.AddSingleLine2("		"+"سرویس های مکانی",(Object)("LOCATION_SOURCE_SETTINGS"));
 //BA.debugLineNum = 59;BA.debugLine="lstv.AddSingleline2(\"		\"&\"تنظیمات کارت حافظه\",\"ME";
mostCurrent._lstv.AddSingleLine2("		"+"تنظیمات کارت حافظه",(Object)("MEMORY_CARD_SETTINGS"));
 //BA.debugLineNum = 60;BA.debugLine="lstv.AddSingleline2(\"		\"&\"ارائه دهندگان سرویس سیم";
mostCurrent._lstv.AddSingleLine2("		"+"ارائه دهندگان سرویس سیمکارت",(Object)("NETWORK_OPERATOR_SETTINGS"));
 //BA.debugLineNum = 61;BA.debugLine="lstv.AddSingleline2(\"NFC\",\"NFCSHARING_SETTINGS\")";
mostCurrent._lstv.AddSingleLine2("NFC",(Object)("NFCSHARING_SETTINGS"));
 //BA.debugLineNum = 62;BA.debugLine="lstv.AddSingleline2(\"		\"&\"فایل پشتیبان و بازنشانی";
mostCurrent._lstv.AddSingleLine2("		"+"فایل پشتیبان و بازنشانی",(Object)("PRIVACY_SETTINGS"));
 //BA.debugLineNum = 63;BA.debugLine="lstv.AddSingleline2(\"		\"&\"تنظیمات امنیتی\",\"SECURI";
mostCurrent._lstv.AddSingleLine2("		"+"تنظیمات امنیتی",(Object)("SECURITY_SETTINGS"));
 //BA.debugLineNum = 64;BA.debugLine="lstv.AddSingleline2(\"		\"&\"تنظیمات صدا\",\"SOUND_SET";
mostCurrent._lstv.AddSingleLine2("		"+"تنظیمات صدا",(Object)("SOUND_SETTINGS"));
 //BA.debugLineNum = 65;BA.debugLine="lstv.AddSingleline2(\"		\"&\"همگام سازی\",\"SYNC_SETTI";
mostCurrent._lstv.AddSingleLine2("		"+"همگام سازی",(Object)("SYNC_SETTINGS"));
 //BA.debugLineNum = 66;BA.debugLine="lstv.AddSingleLine2(\"		\"&\"دیکشنری کاربر\",\"USER_DI";
mostCurrent._lstv.AddSingleLine2("		"+"دیکشنری کاربر",(Object)("USER_DICTIONARY_SETTINGS"));
...
mostCurrent._lstv = new anywheresoftware.b4a.objects.ListViewWrapper();
