...
public class help_act extends Activity implements B4AActivity{
	public static help_act mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "Fast_Accessibility.ModernPl", "Fast_Accessibility.ModernPl.help_act");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (help_act).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "Fast_Accessibility.ModernPl", "Fast_Accessibility.ModernPl.help_act");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "Fast_Accessibility.ModernPl.help_act", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (help_act) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (help_act) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (help_act) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
anywheresoftware.b4a.objects.WebViewWrapper _wb_help = null;
 //BA.debugLineNum = 18;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
 //BA.debugLineNum = 19;BA.debugLine="Activity.Title=\"راهنمای نرم افزار\"";
mostCurrent._activity.setTitle((Object)("راهنمای نرم افزار"));
 //BA.debugLineNum = 20;BA.debugLine="Dim wb_help As WebView";
_wb_help = new anywheresoftware.b4a.objects.WebViewWrapper();
 //BA.debugLineNum = 21;BA.debugLine="wb_help.Initialize(\"\")";
_wb_help.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 22;BA.debugLine="wb_help.LoadUrl(\"file:///android_asset/help_fast_a";
_wb_help.LoadUrl("file:///android_asset/help_fast_accessibility.html");
 //BA.debugLineNum = 23;BA.debugLine="Activity.AddView(wb_help,0,0,Activity.Width,Activi";
mostCurrent._activity.AddView((android.view.View)(_wb_help.getObject()),(int) (0),(int) (0),mostCurrent._activity.getWidth(),mostCurrent._activity.getHeight());
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 37;BA.debugLine="StartActivity(Home_Act)";
