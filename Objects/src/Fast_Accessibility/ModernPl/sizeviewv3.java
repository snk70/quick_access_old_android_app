...
public static int  _vvvvvv7(anywheresoftware.b4a.BA _ba,float _wdh,float _hgh,float _szw,float _szh,int _fs) throws Exception{
float _fs1 = 0f;
float _fs2 = 0f;
float _fs3 = 0f;
float _n1 = 0f;
float _n2 = 0f;
 //BA.debugLineNum = 69;BA.debugLine="Private Sub fsz(wdh As Float,hgh As Float,szw As F";
 //BA.debugLineNum = 70;BA.debugLine="Dim fs1,fs2,fs3 As Float";
_fs1 = 0f;
_fs2 = 0f;
_fs3 = 0f;
 //BA.debugLineNum = 71;BA.debugLine="Dim n1,n2 As Float";
_n1 = 0f;
_n2 = 0f;
 //BA.debugLineNum = 73;BA.debugLine="fs1=getinch(wdh)";
_fs1 = (float)(Double.parseDouble(_vv6(_ba,_wdh)));
 //BA.debugLineNum = 74;BA.debugLine="fs3=getinch(hgh)";
_fs3 = (float)(Double.parseDouble(_vv6(_ba,_hgh)));
 //BA.debugLineNum = 75;BA.debugLine="n1=fs1/szw";
_n1 = (float) (_fs1/(double)_szw);
 //BA.debugLineNum = 76;BA.debugLine="n2=fs3/szh";
_n2 = (float) (_fs3/(double)_szh);
 //BA.debugLineNum = 78;BA.debugLine="If n1>n2 Then";
if (_n1>_n2) { 
 //BA.debugLineNum = 79;BA.debugLine="fs2=n2*fs";
_fs2 = (float) (_n2*_fs);
 }else if(_n2>_n1) { 
 //BA.debugLineNum = 81;BA.debugLine="fs2=n1*fs";
_fs2 = (float) (_n1*_fs);
 }else if(_n1==_n2) { 
 //BA.debugLineNum = 83;BA.debugLine="fs2=n1*fs";
_fs2 = (float) (_n1*_fs);
 };
 //BA.debugLineNum = 86;BA.debugLine="Return fs2*1.5773684210526315789473684210526";
...
public static String  _vv6(anywheresoftware.b4a.BA _ba,float _px) throws Exception{
 //BA.debugLineNum = 63;BA.debugLine="Sub getinch(px As Float)";
 //BA.debugLineNum = 64;BA.debugLine="Dim h As Float";
_vv1 = 0f;
 //BA.debugLineNum = 65;BA.debugLine="h=px/inc";
_vv1 = (float) (_px/(double)_v5);
 //BA.debugLineNum = 66;BA.debugLine="Return h";
if (true) return BA.NumberToString(_vv1);
 //BA.debugLineNum = 67;BA.debugLine="End Sub";
return "";
}
public static double  _vvvvvv0(anywheresoftware.b4a.BA _ba,float _px) throws Exception{
 //BA.debugLineNum = 109;BA.debugLine="Private Sub GetPastHeight(px As Float) As Double";
 //BA.debugLineNum = 111;BA.debugLine="Return (PastHeightScreen/getinch(HeightAct))*getin";
if (true) return (_vv5/(double)(double)(Double.parseDouble(_vv6(_ba,_vv3))))*(double)(Double.parseDouble(_vv6(_ba,_px)));
 //BA.debugLineNum = 112;BA.debugLine="End Sub";
return 0;
}
public static double  _vvvvvvv1(anywheresoftware.b4a.BA _ba,float _px) throws Exception{
 //BA.debugLineNum = 104;BA.debugLine="Private Sub GetPastWidth(px As Float) As Double";
 //BA.debugLineNum = 106;BA.debugLine="Return (PastWidthScreen/getinch(WidthAct))*getinch";
...
_vvvvvvv2(_ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_view.getObject())),_tv,_lv,_hv,_wv,_vv2,_vv3);
 //BA.debugLineNum = 42;BA.debugLine="View.TextSize=fsz(View.Width,View.Height,GetPastWi";
_view.setTextSize((float) (_vvvvvv7(_ba,(float) (_view.getWidth()),(float) (_view.getHeight()),(float) (_vvvvvvv1(_ba,(float) (_view.getWidth()))),(float) (_vvvvvv0(_ba,(float) (_view.getHeight()))),(int) (_fontsize))));
...
_vvvvvvv2(_ba,_view,_tv,_lv,_hv,_wv,_vv2,_vv3);
 //BA.debugLineNum = 38;BA.debugLine="End Sub";
return "";
}
public static String  _vvvvvvv2(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ConcreteViewWrapper _view,float _tv,float _lv,float _hv,float _wv,float _xv,float _yv) throws Exception{
 //BA.debugLineNum = 91;BA.debugLine="Private Sub sizemode(View As View,tv As Float,lv A";
 //BA.debugLineNum = 92;BA.debugLine="View.Top=tv*(yv/DV_Height)";
_view.setTop((int) (_tv*(_yv/(double)_dv_height)));
 //BA.debugLineNum = 93;BA.debugLine="View.Left=lv*(xv/DV_Width)";
_view.setLeft((int) (_lv*(_xv/(double)_dv_width)));
 //BA.debugLineNum = 94;BA.debugLine="View.Width=wv*(xv/DV_Width)";
_view.setWidth((int) (_wv*(_xv/(double)_dv_width)));
 //BA.debugLineNum = 95;BA.debugLine="View.Height=hv*(yv/DV_Height)";
_view.setHeight((int) (_hv*(_yv/(double)_dv_height)));
 //BA.debugLineNum = 97;BA.debugLine="t=View.Top";
_v6 = (float) (_view.getTop());
 //BA.debugLineNum = 98;BA.debugLine="l=View.Left";
_v7 = (float) (_view.getLeft());
 //BA.debugLineNum = 99;BA.debugLine="w=View.Width";
_v0 = (float) (_view.getWidth());
 //BA.debugLineNum = 100;BA.debugLine="h=View.Height";
