...
mostCurrent._size_view._setpx(mostCurrent.activityBA,(float) (mostCurrent._activity.getWidth()),(float) (mostCurrent._activity.getHeight()),(float) (240),(float) (320));
 //BA.debugLineNum = 34;BA.debugLine="size_View.SetPastScreenSizetoInche(3.333,4.444)";
mostCurrent._size_view._setpastscreensizetoinche(mostCurrent.activityBA,(float) (3.333),(float) (4.444));
 //BA.debugLineNum = 36;BA.debugLine="size_View.SetSizeViews(Envelope_ImageView,8,177,4";
mostCurrent._size_view._setsizeviews(mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._envelope_imageview.getObject())),(float) (8),(float) (177),(float) (44),(float) (37),(float) (0));
