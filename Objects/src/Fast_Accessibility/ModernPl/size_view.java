...
public class size_view {
private static size_view mostCurrent = new size_view();
...
public static String  _vvv1(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ConcreteViewWrapper _view,float _tv,float _lv,float _wv,float _hv,float _fontsize) throws Exception{
