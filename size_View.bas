...
Sub SetSize_img(View As ImageView,tv As Float,lv As Float,wv As Float,hv As Float)
sizemode(View,tv,lv,hv,wv,WidthAct,HeightAct)
End Sub

Sub SetSize_seekbar(View As SeekBar,tv As Float,lv As Float,wv As Float,hv As Float)
sizemode(View,tv,lv,hv,wv,WidthAct,HeightAct)
End Sub
